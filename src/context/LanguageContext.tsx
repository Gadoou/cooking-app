...
const translations: Record<string, string> = {
  // UI General
  "Welcome, Foodie!": "ازيك يا مهند 👋",
  "What do you wanna cook today?": "تحب نطبخ ايه النهردا ؟ 🧐",
  "the choice that matches your time and budget": "اختار اللي يناسب وقتك و مزنيتك",
  "search by recipe or ingredient": "بتدور على حاجه معينه ؟ 😎",
  "Quick": "سريع",
  "Budget": "ميزانية",
  "Groups": "مجموعات",
  "All": "الكل",
  "Filter": "تصفية",
  "Suggested Recipes": "دول وصفات علشانك 😉",
  ...
  "mins": "دقائق",
  "Start Guided Cooking": "يلا نبداء طبخ ؟ 🥘",
